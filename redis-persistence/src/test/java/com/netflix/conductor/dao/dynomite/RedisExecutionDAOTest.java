...
public class RedisExecutionDAOTest {
	...
	public void init() {
		...
		dynoClient = new DynoProxy(jedisMock);

		metadataDAO = new RedisMetadataDAO(dynoClient, om, config);
		dao = new RedisExecutionDAO(dynoClient, om, indexDAO, metadataDAO, config);
